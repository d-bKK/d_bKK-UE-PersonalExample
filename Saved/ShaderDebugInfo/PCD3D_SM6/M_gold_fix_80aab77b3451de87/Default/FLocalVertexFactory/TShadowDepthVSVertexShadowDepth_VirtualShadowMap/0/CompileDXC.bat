...
%DXC% -HV 2018 -Zpr -O3 -auto-binding-space 0 -Wno-parentheses-equality -disable-lifetime-markers -T vs_6_6 -E Main -Fc ShadowDepthVertexShader.d3dasm -Fo ShadowDepthVertexShader.dxil ShadowDepthVertexShader.usf
:END
PAUSE
